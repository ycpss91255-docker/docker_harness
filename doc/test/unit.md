...
Unit level (ISTQB): one hook or script in isolation. **1141 tests** across
...
### .claude/test/bats/unit/remind_no_ai_attribution_spec.bats (5)
| Test | Scenario |
|------|----------|
...
### .claude/test/bats/unit/remind_ci_auto_merge_spec.bats (6)
...
### .claude/test/bats/unit/auto_merge_on_green_spec.bats (12)
...
### .claude/test/bats/unit/serial_merge_spec.bats (9)
...
### .claude/test/bats/unit/remind_monitor_on_git_push_spec.bats (11)
...
### .claude/test/bats/unit/wait_pr_ci_batch_spec.bats (37)
...
### .claude/test/bats/unit/fix_dockerfile_lint_lib_spec.bats (6)
...
### .claude/test/bats/unit/batch_open_archive_rename_issues_spec.bats (16)
...
### .claude/test/bats/unit/batch_pr_close_spec.bats (16)
...
### .claude/test/bats/unit/enforce_semver_tag_via_script_spec.bats (29)
...
### .claude/test/bats/unit/new_adr_spec.bats (16)
...
### .claude/test/bats/unit/remind_adr_on_design_decision_spec.bats (12)
...
### .claude/test/bats/unit/update_stale_pr_spec.bats (14)
...
### .claude/test/bats/unit/enforce_merge_update_not_rebase_spec.bats (21)
...
### .claude/test/bats/unit/wait_tag_ci_spec.bats (14)
...
### .claude/test/bats/unit/check_log_helper_usage_spec.bats (13)
...
### .claude/test/bats/unit/remind_log_helper_spec.bats (7)
...
### .claude/test/bats/unit/check_template_versions_spec.bats (7)
...
### .claude/test/bats/unit/batch_mutation_pr_spec.bats (12)
...
### .claude/test/bats/unit/batch_line_edit_spec.bats (4)
...
### .claude/test/bats/unit/batch_gitignore_add_line_spec.bats (7)
...
### .claude/test/bats/unit/batch_gitignore_fix_spec.bats (5)
...
### .claude/test/bats/unit/ci_wall_time_compare_spec.bats (14)
...
### .claude/test/bats/unit/run_bats_in_compose_spec.bats (14)
...
### .claude/test/bats/unit/check_claude_md_ceiling_spec.bats (7)
...
### .claude/test/bats/unit/log_spec.bats (48)
...
### .claude/test/bats/unit/check_tag_version_consistency_spec.bats (15)
...
### .claude/test/bats/unit/check_prefer_dot_sh_spec.bats (20)
...
### .claude/test/bats/unit/enforce_serial_merge_gate_spec.bats (17)
...
### .claude/test/bats/unit/check_no_stale_template_refs_spec.bats (12)
| Test | Scenario |
|------|----------|
...
### .claude/test/bats/unit/setup_memory_link_spec.bats (14)
...
### .claude/test/bats/unit/forensic_worktree_leak_spec.bats (5)
...
### .claude/test/bats/unit/auto_clean_worktree_leak_spec.bats (4)
...
### .claude/test/bats/unit/remind_strategic_compact_spec.bats (24)
...
### .claude/test/bats/unit/remind_main_sync_spec.bats (23)
...
### .claude/test/bats/unit/check_main_fresh_before_worktree_spec.bats (14)
...
### .claude/test/bats/unit/instinct_query_spec.bats (14)
...
### .claude/test/bats/unit/check_no_off_task_suggestions_spec.bats (11)
...
### .claude/test/bats/unit/remind_proactive_optimization_spec.bats (13)
...
### .claude/test/bats/unit/remind_skillification_candidates_spec.bats (16)
...
### .claude/test/bats/unit/remind_parallel_when_bulk_spec.bats (18)
...
### .claude/test/bats/unit/wait_release_spec.bats (13)
...
### .claude/test/bats/unit/skills_canonical_layout_spec.bats (3)
...
| Test | Scenario |
|------|----------|
| the roster is a data file, not a list embedded in a script | - |
| roster_fanout_paths active lists the repos the fanout really touches | - |
