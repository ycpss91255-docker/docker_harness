...
Grand total (all levels): **1206 tests**.

## Test docs by level / type

| Doc | Scope | Count |
|-----|-------|-------|
| [unit.md](unit.md) | `.claude/test/bats/unit/` -- one hook / script in isolation | 1192 |
| [integration.md](integration.md) | `.claude/test/bats/integration/` -- several hooks on one input | 7 |
...
(44 hooks + 40 helper scripts); `... hadolint` lints
